...
class RankingEngine:
    ...
    def set_lifecycle(
        ...
        # Goodreads' actual shelf should follow the lifecycle button.
        # "ignore" is an internal ranker state, so leave the Goodreads
        # shelf unchanged when ignoring a book.
        if status in {
            "to-read",
            "currently-reading",
            "read",
